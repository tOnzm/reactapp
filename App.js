  ...
  for (let i = 0; i < 5; i++) {
    matches.push(
      <View key={i} style={styles.box}>
        <Text style={styles.textTitle}>Premier League</Text>
        ...
        <View style={styles.team}>
          ...
          <View style={styles.score}>
            <Text style={styles.textScore}>18</Text>
            <Text style={styles.textScore}>:</Text>
            <Text style={styles.textScore}>00</Text>
          </View>
          <View>
            <Image
              style={styles.tinyLogo}
            ...
            />
            <Text style={styles.teamName}>ManUTD</Text>
          </View>
          <TouchableOpacity
            style={styles.button}
            onPress={() => {
              Alert.alert("แน่ใจนะ", "คิดดีแล้วใช่มั้ย?", [
                {
                  text: "ยกเลิก",
                  style: "cancel",
                },
                {
                  text: "แน่นอน",
                  onPress: () => {
                    Alert.alert("ถามจริ๊ง!", "ลองทบทวนดูอีกที", [
                      {
                        text: "ยกเลิก",
                        style: "cancel",
                      },
